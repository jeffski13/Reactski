...
class HiveCreatureListProvider() {
    companion object {
        val CREATURE_LIST = mutableListOf(
            HiveCreatureInformation("Overlord",
            ...
            HiveCreatureInformation("Zergling",
            ...
            HiveCreatureInformation("Hydralisk",
            ...
            HiveCreatureInformation("Infested Terran",
            ...
            HiveCreatureInformation("Mutalisk",
            ...
            HiveCreatureInformation("Guardian",
            ...
            HiveCreatureInformation("Scourge",
            ...
            HiveCreatureInformation("Devourer",
    ...
    fun getPreviewList(): List<HiveCreatureInfoCardData> {
        val hiveCreatureInfoCardDataList = mutableListOf<HiveCreatureInfoCardData>()
        hiveCreatureInfoCardDataList.add(HiveCreatureInfoCardData(CREATURE_LIST[0], 0))
        return hiveCreatureInfoCardDataList
    }
}